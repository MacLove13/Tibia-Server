...
exports.RemoveFromBag = exports.RemoveItem = void 0;
const Model = __importStar(require("@models/item"));
const RemoveItem = (itemUuid, quantity) => __awaiter(void 0, void 0, void 0, function* () {
    let result = false;
    try {
...
const RemoveFromBag = (itemUuid, quantity) => __awaiter(void 0, void 0, void 0, function* () {
    let result = false;
    try {
        const item = yield Model.Item.findOne({ where: { uuid: itemUuid } });
        if (item) {
